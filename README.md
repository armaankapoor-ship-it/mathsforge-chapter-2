...
A separate, static Class 12 Mathematics learning website for **Chapter 2: Inverse Trigonometric Functions**. It is part of **MathsForge** and is built as a frontend-only project, so it can be shared publicly through Netlify or GitHub Pages without paid hosting, paid APIs, databases, or subscriptions.
...
```text
https://inverse-trigonometric-functions-forge.netlify.app/
```

GitHub Pages public website:

```text
https://armaankapoor-ship-it.github.io/mathsforge-chapter-2/
```

GitHub repository:

```text
https://github.com/armaankapoor-ship-it/mathsforge-chapter-2
```

## What Is Included

- Topic notes for Inverse Trigonometric Functions
- Formula sheet
...
```text
Site name: inverse-trigonometric-functions-forge
...
2. Create a new public repository named `mathsforge-chapter-2`.
